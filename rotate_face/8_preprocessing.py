...
def normalize_blinks(num_blinks, time_open, u_time_open, sigma_time_open, time_close, u_time_close, sigma_time_close, max_ear, u_max_ear, sigma_max_ear, min_ear, u_min_ear,sigma_min_ear, left_max, u_left_max, sigma_left_max, left_min, u_left_min, sigma_left_min, right_max, u_right_max, sigma_right_max, right_min, u_right_min, sigma_right_min):
...
for window_size in [3,5,10,20,30,60,90]:              #[10,20,30,60,90]
    for i in [1,2,3,4,5]:
        ...
        Training   = './data_preprocess/8_Blinks_'+str(window_size)+'_'+test_fold+'.npy'
        LabelsTrain= './data_preprocess/8_Labels_'+str(window_size)+'_'+test_fold+'.npy'
        Testing    = './data_preprocess/8_BlinksTest_'+str(window_size)+'_'+test_fold+'.npy'
        LabelsTest = './data_preprocess/8_LabelsTest_'+str(window_size)+'_'+test_fold+'.npy'
        len_file = './data_preprocess/8_'+str(window_size)+'_'+test_fold+'.txt'
